...
const NavBar = () => {
  ...
  return (
    <nav>
      {/* <div classNameName="nav-wrapper #1565c0 blue darken-3"> */}
      {/*   <Link href="/"><a classNameName="brand-logo left">MyStore</a></Link> */}
      {/*   <ul id="nav-mobile" classNameName="right"> */}
      {/*   <li classNameName={isActive('/cart')}><Link href="/cart"><a>cart</a></Link></li> */}
      {/*     { */}
      {/*     (user.role == 'admin' || user.role == 'root') && */}
      {/*       <li classNameName={isActive('/create')}><Link href="/create"><a>create</a></Link></li> */}
      {/*     } */}

      {/*     {user ? */}
      {/*     <> */}
      {/*         <li classNameName={isActive('/account')}><Link href="/account"><a>Account</a></Link></li> */}
      {/*         <li><button classNameName="btn red" onClick={()=>{ */}
      {/*           cookie.remove('token') */}
      {/*           cookie.remove('user') */}
      {/*           router.push('/login') */}
      {/*         }}>logout</button></li> */}
      ...
      {/*     : */}
      {/*     <> */}
      {/*     <li classNameName={isActive('/login')}><Link href="/login"><a>login</a></Link></li> */}
      {/*     <li classNameName={isActive('/signup')}><Link href="/signup"><a>signup</a></Link></li> */}
      {/*     </> */}
      {/*     } */}
      ...
      <div className="relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            {/*     {/1* <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" --> *1/} */}
            {/*     <button */}
            {/*       type="button" */}
            ...
            {/*       <span>Solutions</span> */}
            {/*       {/1* <!-- *1/} */}
            {/*       {/1*   Heroicon name: chevron-down *1/} */}

            {/*       {/1*   Item active: "text-gray-600", Item inactive: "text-gray-400" *1/} */}
            {/*       {/1* --> *1/} */}
            {/*       <svg */}
            ...
            {/*     {/1* <!-- *1/} */}
            {/*     {/1*   'Solutions' flyout menu, show/hide based on flyout menu state. *1/} */}

            {/*     {/1*   Entering: "transition ease-out duration-200" *1/} */}
            {/*     {/1*     From: "opacity-0 translate-y-1" *1/} */}
            {/*     {/1*     To: "opacity-100 translate-y-0" *1/} */}
            {/*     {/1*   Leaving: "transition ease-in duration-150" *1/} */}
            {/*     {/1*     From: "opacity-100 translate-y-0" *1/} */}
            {/*     {/1*     To: "opacity-0 translate-y-1" *1/} */}
            {/*     {/1* --> *1/} */}
            ...
            {/*               className="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150" */}
            {/*             > */}
            {/*               {/1* <!-- Heroicon name: cursor-click --> *1/} */}
            {/*               <svg */}
            {/*                 className="flex-shrink-0 h-6 w-6 text-indigo-600" */}
            {/*                 xmlns="http://www.w3.org/2000/svg" */}
            {/*                 fill="none" */}
            ...
            {/*               className="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150" */}
            {/*             > */}
            {/*               {/1* <!-- Heroicon name: shield-check --> *1/} */}
            {/*               <svg */}
            {/*                 className="flex-shrink-0 h-6 w-6 text-indigo-600" */}
            {/*                 xmlns="http://www.w3.org/2000/svg" */}
            {/*                 fill="none" */}
            ...
            {/*     {/1* <!-- *1/} */}
            {/*     {/1*   'More' flyout menu, show/hide based on flyout menu state. *1/} */}
            ...
            {/*               className="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150" */}
            {/*             > */}
            {/*               {/1* <!-- Heroicon name: bookmark-alt --> *1/} */}
            {/*               <svg */}
            {/*                 className="flex-shrink-0 h-6 w-6 text-indigo-600" */}
            {/*                 xmlns="http://www.w3.org/2000/svg" */}
            {/*                 fill="none" */}
            ...
            <div className="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
              {user ? (
                <>
                  <Link href="/cart">
                    <a className="whitespace-no-wrap text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900">
                      Cart
                    </a>
                  </Link>
